...
export interface CityDef {
  key: string;
  name: string;
  /** stone-and-moat hearth, sandstone medina, timber canopy town, ice hold, or gravehollow */
  theme: "stone" | "sand" | "wood" | "ice" | "gothic";
  cx: number;
  cy: number;
   ...
   */
  canal?: { x1: number; y1: number; x2: number; y2: number; w: number };
  gates: CityGate[];
}
