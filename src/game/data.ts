...
export const NPCS: NpcDef[] = [
  ...
  { id: "haven_upgrader", name: "Old Whetstone Tam", title: "Gear Upgrader", ...spot("haven_upgrader", 1017, 2507), robe: "#b7a06d", hair: "#d8d2c4", greeting: "Every notch I grind makes you harder to kill.", services: ["upgrade"] },
