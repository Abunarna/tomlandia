...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Abunaria" },
      { name: "description", content: "Abunaria MMORPG" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Abunaria" },
      { property: "og:description", content: "Abunaria MMORPG" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Abunaria" },
      { name: "twitter:description", content: "Abunaria MMORPG" },
