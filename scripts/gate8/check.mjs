...
run(["scripts/gate8/build-content-catalog.mjs", "--input", "content/v7/manifest.authoring.json", "--check"]);
...
if (!runtime.includes("WORLD_SPAWN_HASH") || !runtime.includes('mode: "maintenance"')) {
